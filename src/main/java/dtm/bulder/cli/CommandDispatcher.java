...
import dtm.bulder.interactive.InteractiveSession;
import dtm.bulder.lifecycle.Phase;
import dtm.bulder.printer.FormaterType;
import dtm.bulder.printer.Printer;
import dtm.bulder.printer.Severity;
import dtm.bulder.printer.exceptions.FormaterTypeException;
...
public final class CommandDispatcher {
    ...
    private void printHelp() {
        ...
        printer.println(Severity.NONE, "  refresh       re-resolve e materializa dependencias");
